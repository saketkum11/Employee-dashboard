  ...
  return (
    <>
      <div className="mt-10 ml-10 max-w-2xl">
        <h2 className="text-xl">Welcom to Hr Management app - A User Guide</h2>
        <h4 className="mt-4 font-semibold">Overview</h4>
        <p className="mt-2">
          Welcome to our <strong>HR management system</strong>. It allows you to
          easily handle all aspects of the hiring process. Our platform is
          dedicated to improving productivity for HR, providing a space for the
          audience to do work efficiently.
        </p>
        ...
        <p className="mt-2">
          Our website is designed for those who have issues managing records of
          their employees, candidates, and job openings. Whether you are an HR
          professional or an employer looking to streamline your hiring process,
          our HR app provides valuable content and services tailored to your
          needs.
        </p>
        ...
        <p className="mt-2">
          ...
          make your journey seamless and enjoyable. Here is a step-by-step guide
          on how to navigate and make the most of our platform:
        </p>
        <p className="mt-2 ml-8">
          1. A dashboard to manage HR queries and notifications.
        </p>
        <p className="mt-2 ml-8">
          2. An employee management panel is designed to handle all work related
